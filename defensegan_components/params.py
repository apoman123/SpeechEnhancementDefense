...
# DataSet Path
#############################s
target_signals_dir = '/data/nas07/SharedBySMB/apoman123/wavegan_vctk_files/'
#############################
# Model Params
#############################
model_prefix = 'wavegan_vctk' # name of the model to be saved
n_iterations = 100000
use_batchnorm = False
lr_g = 1e-3
...
output_dir = "/data/nas07/PersonalData/apoman123/wavegan_vctk"
