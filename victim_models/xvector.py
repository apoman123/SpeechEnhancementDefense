...
class X_vector(nn.Module):
    def __init__(self, input_dim=60, num_classes=8):
    ...
    def get_embeddings(self, inputs):
        batchnorm_out = self.input_batchnorm(inputs)
        batchnorm_out = batchnorm_out.transpose(1, 2)
        tdnn1_out = self.tdnn1(batchnorm_out)
